...
const createCharacter = (): Character => {
  return {
    ...
    ancestry: faker.helpers.arrayElement([
      'dwarf',
      'elf',
      'gnome',
      'goblin',
    ...
    heritage: faker.helpers.arrayElement([
      'ancient-bones',
      'charhide',
      'charnomicon',
      'deep-earths',
...
export async function GET() {
  const characters: Array<Character> = faker.helpers.multiple<Character>(
    createCharacter,
    {
      count: faker.number.int({ min: 5, max: 12 }),
    }
  );
